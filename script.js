...
// create objects using the class on line 34
...
// so it can be accessed by the forEach, line 73
...
function animate() {
  ...
  // setting frame rate to decrement will move the frame right to left
  // i would have to change more than just this but if gameFrame is set to
